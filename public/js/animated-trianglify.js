...
function drawTriangs() {
    ...
    t = new Trianglify({ noiseIntensity: 0, format: "png", x_gradient: colors, points: vertices });
...
function Trianglify(options) {
    ...
    // defaults
    this.options = {
        cellsize: defaults(options.cellsize, 20), // zero not valid here
        bleed: defaults(options.cellsize, 20),
