...
var HTMLmobile = '<li class="flex-item"><a href="http://www.twitter.com/theednaffattack" target="_blank"><i class="fa fa-twitter fa-5x"></i></a></li>';
var HTMLemail = '<li class="flex-item"><i class="orange-text orange-text fa fa-envelope-o"></i>'; //<span class="white-text">%data%</span></li>';


var HTMLtwitter =     '<a href="http://www.twitter.com/theednaffattack" target="_blank">'+
...
var HTMLgithub =      '<a href="http://github.com/theednaffattack" target="_blank">'+
                      '<span class="fa-stack fa-2x">'+
                      '<i class="fa fa-circle fa-stack-2x"></i>'+
...
var HTMLskills = '<li class="flex-item text-center">%data%</li>';
